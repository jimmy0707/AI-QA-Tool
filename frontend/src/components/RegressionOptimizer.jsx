...
export default function RegressionOptimizer() {
  ...
  const handleSubmit = async () => {
    ...
    if (formData.recent_modification_days)
      fd.append("recent_modification_days", formData.recent_modification_days);
    ...
    <div className="feature-page">
      <div className="feature-header">
        ...
        <p className="feature-desc">
          Upload your test suite (up to 2,000 cases). AI analyzes risk and assigns P1/P2/P3 priorities
          based on your team's execution capacity.
        </p>
      </div>
      ...
      <div className="content-grid">
        ...
        <div className="card">
          <h3 className="card-title">
            <span className="step-badge">1</span> Upload Test Cases
          </h3>
          <div
        ...
        <div className="card">
          <h3 className="card-title">
            <span className="step-badge">2</span> Execution Planning
          </h3>
          <div className="form-grid">
            <div className="form-group">
              ...
              <input
                ...
                placeholder="e.g. 30"
                value={formData.recent_modification_days}
                onChange={(e) => setFormData({ ...formData, recent_modification_days: e.target.value })}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                placeholder="e.g. 5"
                min="1"
                value={formData.total_execution_days}
                onChange={(e) => setFormData({ ...formData, total_execution_days: e.target.value })}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                placeholder="e.g. 3"
                min="1"
                value={formData.total_testers}
                onChange={(e) => setFormData({ ...formData, total_testers: e.target.value })}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                placeholder="e.g. 20"
                min="1"
                value={formData.cases_per_tester_per_day}
                onChange={(e) => setFormData({ ...formData, cases_per_tester_per_day: e.target.value })}
              />
            </div>
          </div>
          ...
          {capacity > 0 && (
            <div className="capacity-pill">
              ⚡ Execution Capacity: <strong>{capacity}</strong> test cases
            </div>
          )}
        </div>
      </div>
      ...
      {loading && (
        <div className="progress-card">
          ...
          <p className="progress-text">AI is analyzing risk scores and calculating execution plan...</p>
        </div>
      )}
        ...
        <div className="results-section">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card p1">
              <div className="stat-value">{result.p1_count}</div>
              <div className="stat-label">P1 Critical</div>
            </div>
            <div className="stat-card p2">
              <div className="stat-value">{result.p2_count}</div>
              <div className="stat-label">P2 Moderate</div>
            </div>
            <div className="stat-card p3">
              <div className="stat-value">{result.p3_count}</div>
              <div className="stat-label">P3 Low</div>
            </div>
            <div className="stat-card recommended">
              <div className="stat-value">{result.recommended_count}</div>
              <div className="stat-label">Recommended</div>
            </div>
            <div className="stat-card coverage">
              <div className="stat-value">{result.coverage_percent}%</div>
          ...
          <div className="coverage-bar-section">
            <div className="coverage-label">
              ...
              <span>{result.coverage_percent}%</span>
            </div>
            <div className="coverage-track">
              <div
                className="coverage-fill"
                style={{ width: `${result.coverage_percent}%` }}
              />
            </div>
          </div>
